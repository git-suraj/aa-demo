...
# Local Keycloak client credential used by the AI Gateway 2.0 OIDC identity provider.
export AIGW_KEYCLOAK_KONG_MCP_CLIENT_SECRET="${AIGW_KEYCLOAK_KONG_MCP_CLIENT_SECRET:-kong-mcp-demo-secret}"
# decK only permits DECK_-prefixed environment variables in state templates.
# DataKit uses this alias for the RFC 8693 client authentication field.
export DECK_KEYCLOAK_MCP_CLIENT_SECRET="${DECK_KEYCLOAK_MCP_CLIENT_SECRET:-${AIGW_KEYCLOAK_KONG_MCP_CLIENT_SECRET}}"
